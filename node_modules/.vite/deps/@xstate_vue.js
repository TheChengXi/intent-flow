...
import {
  ...
  shallowRef,
  watch
} from "./chunk-SP5P5C3M.js";

// ../../../../../node_modules/@xstate/vue/dist/xstate-vue.development.esm.js
...
function useSelector(actor, selector, compare = defaultCompare) {
  ...
  const selected = shallowRef(selector((_a = actorRefRef.value) == null ? void 0 : _a.getSnapshot()));
  ...
  watch(actorRefRef, (newActor, _, onCleanup) => {
    selected.value = selector(newActor == null ? void 0 : newActor.getSnapshot());
    if (!newActor) {
      return;
    }
