// ../../../../../node_modules/xstate/dist/xstate-dev.development.esm.js
function getGlobal() {
...
// ../../../../../node_modules/xstate/dist/raise-45f11c00.development.esm.js
var Mailbox = class {
      ...
      subscribe: (observerOrFn) => {
        ...
        return this.subscribe((snapshot2) => {
          ...
          if (!equalityFn(previousSelected, nextSelected)) {
            ...
            (_a = observer.next) == null ? void 0 : _a.call(observer, nextSelected);
          }
        });
      },
...
function macrostep(snapshot, event, actorScope, internalQueue) {
  ...
  const maxIterations = ((_a = snapshot.machine.options) == null ? void 0 : _a.maxIterations) ?? Infinity;
...
// ../../../../../node_modules/xstate/dist/xstate-actors.development.esm.js
...
// ../../../../../node_modules/xstate/dist/assign-43b1b558.development.esm.js
...
// ../../../../../node_modules/xstate/dist/StateMachine-23c204bb.development.esm.js
...
// ../../../../../node_modules/xstate/dist/log-db444cad.development.esm.js
...
function mapState(snapshot, mapper) {
  ...
  const findMapper = (currentMapper, nodePath) => {
    ...
    for (const key of nodePath) {
      if (!(mapper2 == null ? void 0 : mapper2.states)) {
        return void 0;
      }
  ...
  for (const atomicNode of snapshot._nodes.filter(isAtomicStateNode)) {
    ...
    while (current && !visited.has(current)) {
      ...
      if (nodeMapper == null ? void 0 : nodeMapper.map) {
        results.push({
          stateNode: current,
...
//# sourceMappingURL=chunk-KRBHDNAA.js.map
