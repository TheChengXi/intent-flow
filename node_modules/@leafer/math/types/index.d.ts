...
declare const PointHelper: {
    ...
    rotate(t: IPointData, rotation: number, origin?: IPointData, radiusX?: number, radiusY?: number): void;
    ...
    getAtan2(t: IPointData, to: IPointData, radiusX?: number, radiusY?: number): number;
