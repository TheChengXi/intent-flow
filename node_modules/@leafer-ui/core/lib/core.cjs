        ...
        if (list.length && running) {
            ...
            list.forEach(leaf => {
                if (leaf.draggable) {
                    ...
                    if (dragLimitAnimate && !axisDrag && isDragEnd) core.LeafHelper.animateMove(leaf, move, core.isNumber(dragLimitAnimate) ? dragLimitAnimate : .3, () => leaf.emit(exports.DragEvent.ANIMATE)); else leaf.move(move);
                }
            });
        }
    }
