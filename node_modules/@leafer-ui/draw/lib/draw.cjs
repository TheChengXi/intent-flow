...
exports.UI = UI_1 = class UI extends core.Leaf {
    ...
    __updateRenderPath(updateCache) {
        const data = this.__;
        if (data.path) {
            data.__pathForRender = data.cornerRadius || data.path.radius ? core.PathCorner.smooth(data.path, data.cornerRadius, data.cornerSmoothing) : data.path;
...
exports.Ellipse = class Ellipse extends exports.UI {
    ...
    __updatePath() {
        ...
        if (core.Platform.ellipseToCurve || data.__useArrow || data.cornerRadius) data.path = this.getPath(true);
    }
};
...
exports.Polygon = class Polygon extends exports.UI {
    ...
    __updatePath() {
        ...
        if (data.points) {
            ...
            if (startAngle) {
                startRadian = startAngle * core.OneRadian;
...
__decorate([ core.pathType(0) ], exports.Polygon.prototype, "startAngle", void 0);
...
__decorate([ core.pathType(0) ], exports.Star.prototype, "startAngle", void 0);
