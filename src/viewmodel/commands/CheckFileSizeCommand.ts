...
import { FileMetricsService } from '../../model/services/FileMetricsService';
import { extractIntentWithDependencies, checkDependencyBranchSize } from '../../model/services/IntentExtractor';
