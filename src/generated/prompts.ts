...
export const COMPILER_PROMPT = `你是编译器。将注释忠实翻译为代码，严格遵循 COMPILE_SPEC.md。
工作范围：
...
export const PLANNER_PROMPT = `你是迭代规划师。评估变更影响，规划路径，调度角色。
...
export const REVIEWER_PROMPT = `你是代码审查员。以注释为标尺审计代码，不修改代码。
工作范围：
- 当前工作行的注释和代码
...
export const TRANSLATOR_PROMPT = `你是代码转译员，古法编程到 CDD 的双向桥梁。
