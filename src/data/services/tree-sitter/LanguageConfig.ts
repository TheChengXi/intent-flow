...
export class LanguageConfig {
  ...
  private static readonly COMMENT_BLOCK_DELIMITERS: {
    [key: string]: { start: string; end: string; linePrefix: string }
  } = {
  ...
  static getCommentBlockDelimiters(language: string): { start: string; end: string; linePrefix: string } | null {
