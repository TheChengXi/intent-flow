...
exports.TypeDefinitionSearcher = void 0;
...
class TypeDefinitionSearcher {
    ...
    static async searchInFile(typeName, filePath, language) {
        ...
        try {
            ...
            if (language) {
                return await this.searchWithTreeSitter(typeName, content, language);
            }
...
exports.TypeDefinitionSearcher = TypeDefinitionSearcher;
//# sourceMappingURL=TypeDefinitionSearcher.js.map