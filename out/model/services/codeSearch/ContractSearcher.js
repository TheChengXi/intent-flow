...
exports.ContractSearcher = void 0;
...
class ContractSearcher {
    ...
    // @boundary: 当文件不存在时，返回 null
    // @boundary: 当契约未找到时，返回 null
    static async searchInFile(functionName, filePath) {
    ...
    // @step: [返回] 返回契约文本或 null
    // @boundary: 当找不到契约时，返回 null
    static async searchInWorkspace(functionName, workspaceRoot) {
    ...
    // @step: [返回] 返回契约文本、文件路径、相对路径和导入路径
    // @boundary: 当找不到契约时，返回 null
    static async searchInWorkspaceWithPath(functionName, workspaceRoot) {
        const vscode = require('vscode');
        const fs = require('fs').promises;
...
exports.ContractSearcher = ContractSearcher;
//# sourceMappingURL=ContractSearcher.js.map